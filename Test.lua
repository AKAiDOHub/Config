...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    main.BackgroundTransparency = if transparency == true and 0.08 end
    ...
    function window:Section(name)
        ...
        function sec:TextField(name, placeholder, callback)
            ...
            textfield.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
            ...
            textfield.Text = name
            textfield.TextColor3 = Color3.fromRGB(240, 240, 240)
